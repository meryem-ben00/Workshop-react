...
export default function Review() {
    ...
    return ( <
        ...
        <
        h3 className = "font-medium text-base text-white" > Basic information < /h3> <
        /div> <
        ...
        div className = "flex flex-col w-[100%]" >
        <
        label className = "font-normal text-xs text-[#5F8D4E] pb-1" > Your gender <
        /label> <
