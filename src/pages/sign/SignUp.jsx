...
export default function SignUp() {
    return ( <
        ...
        <
        h2 className = 'text-black font-bold text-lg ' > Welcome < br / > Create your account < /h2> <
        /div> <
        ...
        className = 'w-[255px] bg-[#DCDCDC] outline-none rounded mb-2 focus:text-black  ' / >
        <
        label className = 'text-black font-normal text-xs  pb-1' > Password < /label> <
        input type = 'password'
        className = 'w-[255px] bg-[#DCDCDC] outline-none rounded mb-2 focus:text-black' / >
        <
        label className = 'text-black font-normal text-xs  pb-1' > Confirm Password < /label> <
        input type = 'password'
        className = 'w-[255px] bg-[#DCDCDC] outline-none rounded mb-2 focus:text-black' / >
        ...
        <
        h3 className = 'text-black text-[9px] font-normal' > Or Sign Up With < /h3> <
        ...
        <
        button className = 'bg-[#2E8544] text-[9px] p-2 w-full rounded font-bold' > Sign up < /button> <
        /div> <
        ...
        div className = 'w-full' >
        <
        Link to = "/SignIn" > < button className = 'bg-[#DCDCDC] text-black text-[9px] p-2 w-full rounded font-bold' > Sign in < /button></Link >
