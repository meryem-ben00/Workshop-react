...
export default function SignIn() {
    return ( <
        ...
        <
        h2 className = 'text-black font-bold text-lg ' > Sign into < br / > your account < /h2> <
        /div> <
        ...
        label
        for = 'remember'
        className = 'text-black text-[9px] font-normal' > Remember Me < /label> <
        /div> <
        div className = 'flex flex-col justify-center items-center mb-3' >
        <
        h3 className = 'text-black text-[9px] font-normal' > Or Sign In With < /h3> <
        ...
        <
        button className = 'bg-[#2E8544] text-[9px] p-2 w-full rounded font-bold' > Sign in < /button> <
        /div> <
        ...
        div className = 'w-full' >
        <
        Link to = "/SignUp" > < button className = 'bg-[#DCDCDC] text-black text-[9px] p-2 w-full rounded font-bold' > Sign Up < /button></Link >
