...
function Settings_password() {
  ...
  <p id="settings" className="text-white font-800 text-[30px] h-9 absolute top-[112px] left-[51px] whitespace-nowrap">
        ...
        <div id="frame-2" className="relative h-[36px]">
            <div id="account-setting-wrapper" className="absolute top-0 left-0 h-[27px] w-[186px]">
                <p id="account-setting" className="font-[700] text-[20px] absolute top-[-1px] left-[12px]">
                    ...
                    <ActiveNavLink to="/settings">Account&nbsp;&nbsp;Setting</ActiveNavLink>
                    </span>
                </p>
            </div>
        </div>
    ...
    <div id="group-5" className="h-[81px] left-[267px] absolute text-[#4B5563] top-[297px] w-[543px]">
      <label htmlFor="overlap-group" className="text-[#ffffff]">Recent Password</label>
      <input id="overlap-group" className="bg-#fafbfc text-#4B5563 rounded-[8px] h-[52px] left-0 absolute top-[29px] w-[519px] p-2 px-3" type="password" placeholder="Please enter the Recent Password" />
    </div>
    <div id="group-5" className="h-[81px] left-[267px] absolute text-[#4B5563] top-[417px] w-[543px]">
      <label htmlFor="overlap-group" className="text-[#ffffff]">New Password</label>
      <input id="overlap-group" className="bg-#fafbfc text-#4B5563 rounded-[8px] h-[52px] left-0 absolute top-[29px] w-[519px] p-2 px-3" type="password" placeholder="Please enter the New Password" />
    </div>
    <div id="group-5" className="h-[81px] left-[267px] absolute  text-[#4B5563] top-[537px] w-[543px]">
      <label htmlFor="overlap-group" className="text-[#ffffff]">Confirm Password</label>
      <input id="overlap-group" className="bg-#fafbfc text-#4B5563 rounded-[8px] h-[52px] left-0 absolute top-[29px] w-[519px] p-2 px-3" type="password" placeholder="Please Confirm the Password" />
    </div>
