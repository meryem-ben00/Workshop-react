  ...
  return (
    <div className="bg-blue-900 flex flex-row justify-center w-full">
      <div className="bg-blue-900 border-none h-240 w-screen">
        <div
          id="div1"
          className="absolute left-24 top-28 w-[1241px] flex flex-row items-end justify-between"
        >
            ...
            <button className="h-10 w-[177px] border-box rounded-lg bg-[#5f8d4e] flex items-center justify-center px-3">
              <div className="w-5 h-5 bg-center bg-no-repeat bg-cover mr-3">
                <img
                  ...
                  alt="Combined shape"
                  src={combined_shape_2x}
                />
                <img
                  className="mt-1 w-[15px] h-[7px]"
                  alt="Mask copy"
                  src={mask_copy_2x}
                />
              </div>
        ...
        <div
          id="div3_R1"
          className="absolute h-[50px] left-[100px] top-[259px] w-[1240px]"
        >
        ...
        <div
          id="div3_R2"
          className="absolute h-[50px] left-[100px] top-[339px] w-[1240px]"
        >
          <div className="absolute bg-[#fafafa] rounded-[6px] h-[32px] w-[32px] left-[1208px] top-[9px]">
            <div className="bg-center bg-no-repeat bg-cover h-[20px] w-[20px] relative left-[6px] top-[6px]">
              <div className="absolute bg-[#181c32] opacity-30 rounded-[1px] h-[7px] w-[2px] left-[6px] top-[6px] transform rotate-[90deg]" />
        ...
        <div
          id="div3_R3"
          className="absolute h-[50px] left-[100px] top-[419px] w-[1240px]"
        >
          <div className="absolute bg-[#fafafa] rounded-[6px] h-[32px] w-[32px] left-[1208px] top-[9px]">
            <div className="bg-center bg-no-repeat bg-cover h-[20px] w-[20px] relative left-[6px] top-[6px]">
              <div className="absolute bg-[#181c32] opacity-30 rounded-[1px] h-[7px] w-[2px] left-[6px] top-[6px] transform rotate-[90deg]" />
        ...
        <div
          id="div3_R4"
          className="absolute h-[50px] left-[100px] top-[499px] w-[1240px]"
        >
          <div className="absolute bg-[#fafafa] rounded-[6px] h-[32px] w-[32px] left-[1208px] top-[9px]">
            <div className="bg-center bg-no-repeat bg-cover h-[20px] w-[20px] relative left-[6px] top-[6px]">
              <div className="absolute bg-[#181c32] opacity-30 rounded-[1px] h-[7px] w-[2px] left-[6px] top-[6px] transform rotate-[90deg]" />
        ...
        <div
          id="div3_R5"
          className="absolute h-[50px] left-[100px] top-[579px] w-[1240px]"
        >
          <div className="absolute bg-[#fafafa] rounded-[6px] h-[32px] w-[32px] left-[1208px] top-[9px]">
            <div className="bg-center bg-no-repeat bg-cover h-[20px] w-[20px] relative left-[6px] top-[6px]">
              <div className="absolute bg-[#181c32] opacity-30 rounded-[1px] h-[7px] w-[2px] left-[6px] top-[6px] transform rotate-[90deg]" />
        ...
        <div
          id="div3_R6"
          className="absolute h-[50px] left-[100px] top-[659px] w-[1240px]"
        >
          <div className="absolute bg-[#fafafa] rounded-[6px] h-[32px] w-[32px] left-[1208px] top-[9px]">
            <div className="bg-center bg-no-repeat bg-cover h-[20px] w-[20px] relative left-[6px] top-[6px]">
              <div className="absolute bg-[#181c32] opacity-30 rounded-[1px] h-[7px] w-[2px] left-[6px] top-[6px] transform rotate-[90deg]" />
        ...
        <div
          id="div3_R7"
          className="absolute h-[50px] left-[100px] top-[739px] w-[1240px]"
        >
          <div className="absolute bg-[#fafafa] rounded-[6px] h-[32px] w-[32px] left-[1208px] top-[9px]">
            <div className="bg-center bg-no-repeat bg-cover h-[20px] w-[20px] relative left-[6px] top-[6px]">
              <div className="absolute bg-[#181c32] opacity-30 rounded-[1px] h-[7px] w-[2px] left-[6px] top-[6px] transform rotate-[90deg]" />
        ...
        <div
          id="div4"
          className="absolute h-10 w-[416px] left-[512px] top-[864px]"
        >
